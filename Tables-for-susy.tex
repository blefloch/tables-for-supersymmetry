...
\renewcommand{\paragraph}[1]{\@startsection {paragraph}{4}{\z@ }{-\smallskipamount}{-1sp}{\normalfont \bfseries }{#1}\hspace{0pt}}
\makeatother
...
\section{Lie algebras and groups}
...
\subsection{Homotopy groups $\pi_n$ of Lie (super)groups}
