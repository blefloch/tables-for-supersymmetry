...
For any~$G$ there exists $\prod_{i=1}^{\rank G} S^{2k_i-1}\to G$ which induces isomorphisms of rational (\ie, torsion-free part of) homotopy/\allowbreak cohomology groups where $k_i$~are the degrees of fundamental invariants.  For compact simple~$K$,
\begin{center}
