...
The UV R-symmetry can be a mixture of the true IR R-symmetry ($\in$ superconformal algebra) and of a flavour symmetry:  $R_{\text{UV}}\subset R_{\text{IR}}\times F$.
For nonabelian R-symmetry that flavour symmetry must be accidental: it does not commute with~$R_{\text{UV}}$.
