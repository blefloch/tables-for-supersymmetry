...
$\zeta(s)=\operatorname{Li}_s(1)$ where
$\operatorname{Li}_s(z)=\sum_{k\geq 1}z^k/k^s=\bigl(1/\Gamma(s)\bigr)\int_0^\infty t^{s-1}\mathrm{d}t/(e^t/z-1)$ obeys
$\operatorname{Li}_{s+1}(z)=\int_0^z\operatorname{Li}_s(t)\mathrm{d}t/t$ and
