...
\paragraph{ADE classification} of simply laced simple Lie algebras, of integers $1\leq p\leq q\leq r$ with $1/p+1/q+1/r>1$, of singularities, \etc.
\begin{tab}{*{3}{>{$}l<{$}}}
  \lie{G} & (p,q,r) & \text{polynomial} \\
  \lie{A}_k & (1,q,1+k-q) & x^2+y^{k+1} \\
  \lie{D}_k & (2,2,k-2) & x^2y+y^{k-1} \\
  \lie{E}_6 & (2,3,3) & x^3+y^4 \\
  \lie{E}_7 & (2,3,4) & x^3+xy^3 \\
  \lie{E}_8 & (2,3,5) & x^3+y^5 \\
\end{tab}\label{page:ADE-polynomial}
