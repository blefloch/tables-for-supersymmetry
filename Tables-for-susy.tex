...
%$\lie{sp}(2n)=\lie{sp}(2n,\RR)$,
$\lie{su}^*(2n)=\lie{sl}(n,\HH)$,
$\lie{so}^*(2n)=\lie{o}(n,\HH)$,
$\lie{usp}(2m,2n)=\lie{u}(m,n,\HH)$.
...
\midrule
\multirow{3}{*}{\rotatebox{90}{$\!\!\!\lie{sp}(2n,\RR)\!\!$}}
& $\lie{usp}(2n)$ & compact & \\
...
\lie{so}(2,1) &=\lie{su}(1,1)=\lie{sl}(2)=\lie{sp}(2,\mathrlap{\RR)}\\
...
\begin{tab}{@{ }l@{ \ }l@{ \ }l@{ }}
  ...
  \rlap{Almost hypercomplex} & & Action $\HH\actson TX$ \\
\end{tab}
...
% Todo double check Kähler ⊃ Calabi-Yau ⊃ hyper-Kähler.
