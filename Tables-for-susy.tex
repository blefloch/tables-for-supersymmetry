...
For any~$G$ there exists $\prod_{i=1}^{\rank G} S^{2k_i+1}\to G$ which induces isomorphisms of rational (\ie, torsion-free part of) homotopy/\allowbreak cohomology groups:
\begin{align*}
  S^3\times S^5\times\cdots\times S^{2n-1} & \simeq_{\QQ} \Lie{SU}(n) \\
  S^3\times S^7\times\cdots\times S^{4n-1} & \simeq_{\QQ} \Lie{USp}(2n) \simeq_{\QQ} \Lie{SO}(2n+1) \\
  \Lie{SO}(2n-1) \times S^{2n-1} & \simeq_{\QQ} \Lie{SO}(2n) \,.
\end{align*}
$\pi_{j\geq 2}(G)$ has a factor~$\ZZ$ for each~$S^j$ above, and some torsion.
Explicitly, $\pi_j(\Lie{SU}(n))$ is $\ZZ$~for odd~$j<2n$, $0$~for even~$j<2n$, and pure torsion for $j\geq 2n$.
Similarly, for $j<4n$, $\pi_j(\Lie{USp}(2n))$ is $\ZZ$~for $j\equiv 3,7\bmod{8}$, $\ZZ_2$~for $j\equiv 4,5\bmod{8}$, and $0$~otherwise.
