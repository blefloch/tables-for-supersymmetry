...
\subsection{Explicit supersymmetry algebras}
...
Komargodski--Seiberg multiplet \href{https://arxiv.org/abs/1002.2228}{[1002.2228]}
...
The vector multiplet scalars and gauge field are $U(1)_R$ neutral.
...
Field strength $W_\alpha=-\frac{1}{4}\overline{D}\overline{D}e^{-V}D_\alpha e^V$ and $\overline{W}_\alpha=-\frac{1}{4}DDe^{-V}\overline{D}_\alpha e^V$.

\paragraph{Wess-Zumino model:} chiral multiplet~$\phi$ with superpotential $W=m\phi^2+g\phi^3$.

\paragraph{3d \(\Nsusy=2\)} \href{http://arXiv.org/abs/hep-th/9703110}{[hep-th/9703110]}
