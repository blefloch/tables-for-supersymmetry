...
For any~$G$ there exists $\prod_{i=1}^{\rank G} S^{2k_i+1}\to G$ which induces isomorphisms of rational (\ie, torsion-free part of) homotopy/\allowbreak cohomology groups.  For compact simple~$K$, these spheres are
\begin{center}
\vspace{-1.3\baselineskip}
\begin{minipage}[t]{.5\linewidth}%
\begin{tab}{@{}>{$}l<{$}@{ }>{$}l<{$}@{}}
  \text{Group} & (2k_i+1) \\\midrule
...
% todo: find the product of sphere to which each compact exceptional group is rational homotopic.
